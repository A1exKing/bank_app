...
class StatisticPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    //calculateIncomeAndExpenses( "R7PWySZ8vfYmcsok80dFczPwhRd2");
    return Scaffold(
      appBar: AppBar(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          future: calculateIncomeAndExpenses(getCurrentUserUid()),
          builder: (context, snapshot) {
            ...
            return Column(
              ...
              subtitle: Text(snapshot.data["totalIncome"].toString() ?? '0.00'),
            ),
            ListTile(
              title: Text('Total Expenses'),
              subtitle: Text(snapshot.data["totalExpenses"].toString() ?? '0.00'),
            )
              ],
            );
          },
...
Future<dynamic> calculateIncomeAndExpenses(String userId) async {
